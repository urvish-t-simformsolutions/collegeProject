...
const ProductDetail = (props) => {
  ...
  return (
    <>
      <section className="pd_bg"></section>
      <section>
            ...
            <div className="card_area">
              <div className="product_count_area">
                ...
                <div className="product_count ">
                  <span className="product_count_item " onClick={decrement}>
                    {" "}
                    <i className="fa fa-minus"></i>
                  </span>
                  <span className="product_count_item value">{value}</span>
                  <span className="product_count_item" onClick={increment}>
                    {" "}
              ...
              <div className="add_to_cart">
                <button
                  onClick={() => {
                    cartpage(props.location.state.item, value);
                  }}
                  className="btn_4"
                >
                  {" "}
...
const mapDispatchToProps = (dispatch) => {
  return {
    onAddToCart: (cart, quantity) =>
      dispatch(actions.addToCart(cart, quantity)),
    addToCartDb: (details, id) => dispatch(actions.addToCartDb(details, id)),
  };
};
